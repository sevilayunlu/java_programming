...
public class Person {
    ...
    public Person(String name) {//allows us to create person object just by setting the name
        this.name = name;
    }

    public Person(String name, int age) {//allows us to create person object just by setting the name and age
        this(name);
       this.age = age;
    }
