...
public class WarmUpTasks {
    ...
    public static void main(String[] args) {
        ...
        String str4=combine("one","two");
        System.out.println(str4);
        System.out.println("--------------------------------------");
        System.out.println(sumOf2IntegerNumbers(10,20));
        System.out.println(sumOf3IntegerNumbers(12,23,34));
        System.out.println(sumOf4IntegerNumbers(13,23,34,45));
    ...
    public static String combine(String str1, String str2) {
        ...
        /*if (str1.endsWith("" + str2.charAt(0))) {// if the first string ends with the second character of the second string
            result = str1 + str2.substring(1);
        } else {
            result = str1 + str2;
        }*/
        if (str1.charAt(str1.length()-1)== str1.charAt(0)){
            result=str1+str2.substring(1);//the first character of the second string should be excluded
        }else{
            result=str1+str2;
        }
        return result;
