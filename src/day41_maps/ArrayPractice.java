...
public class ArrayPractice {
    ...
    public static void main(String[] args) {
        ...
        List<Integer>[] arrayOfLists=new List[3];//data type of the array should be a List.Array supports both primitive and non-primitive types
         //any object is supported both in collection and in the array.
