...
public class ArrayUtilityMethods {
    public static void main(String[] args) {
        ...
        int[] a1 = {1, 2, 3, 4, 5};
        int[] a2 = {1, 2, 3, 4, 5};
        boolean r1 = Arrays.equals(a1, a2);//equals method checks the elements index by index, elements and also the order must be exactly the same to get true.
        ...
        int[] nums = {100, 80, 45, 67, 89, 4, 5, 6, 7, 10000, 500};
        ...
        char[] result2=Arrays.copyOfRange(ch, 2,5);//copyOFRange method excludes the last index
