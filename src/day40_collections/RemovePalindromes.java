...
public class RemovePalindromes {
    public static void main(String[] args) {
        ...
        names2.removeIf(p-> StringUtility.reverse(p).equalsIgnoreCase(p));//we used  a custom method
       // names2.removeIf(p->new StringBuilder(p).reverse().toString().equalsIgnoreCase(p));//we used the built-in method
