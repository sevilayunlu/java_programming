...
public class Car {
    ...
    public Car(String model, String color, int year, double price) {
        setMake(getClass().getSimpleName());//setting the class name to the name of the car.
        // This method returns String and at the end, that string will be set to the name of the car
        setModel(model);
        setColor(color);
        setYear(year);
        setPrice(price);
    ...
    public void setYear(int year) {
        if (year <= 0) {//if specified year negative or zero, exit the program
