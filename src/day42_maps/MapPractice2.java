...
public class MapPractice2 {
    public static void main(String[] args) {
        ...
        System.out.println("------------------------------------------------");
        //display the names of the employees  who are hired in 2022
        ...
        listOfMaps.get(1).replace("age", ((Integer)listOfMaps.get(1).get("age"))+4);//we cannot apply the plus operator to an object directly,
        // that's why, we need to down cast to Integer
        System.out.println(listOfMaps);
